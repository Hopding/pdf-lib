...
*Defined in [core/pdf-document/PDFDocumentFactory.ts:27](https://github.com/Hopding/pdf-lib/blob/0d3a994/src/core/pdf-document/PDFDocumentFactory.ts#L27)*
...
*Defined in [core/pdf-document/PDFDocumentFactory.ts:54](https://github.com/Hopding/pdf-lib/blob/0d3a994/src/core/pdf-document/PDFDocumentFactory.ts#L54)*
