...
*/
var Do = function (_PDFOperator) {
  _inherits(Do, _PDFOperator);

  // TODO: See if the "name" must be preceded by a "/" or not...
  function Do(name) {
    _classCallCheck(this, Do);

    var _this = _possibleConstructorReturn(this, (Do.__proto__ || Object.getPrototypeOf(Do)).call(this));

    _initialiseProps.call(_this);

    (0, _validate.validate)(name, _lodash2.default.isString, 'Do operator arg "name" must be a string.');
    _this.name = name;
    return _this;
  }
