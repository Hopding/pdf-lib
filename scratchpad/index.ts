...
(async () => {
  ...
  // const tf1 = form.getTextField(
  //   'form1[0].Page1[0].BeforeYouBegin[0].BusinessInfo[0].AccountNumber[0].BusinessNumber_RT1[0]',
  // );
  // tf1.setText('Testing');
  // tf1.updateAppearances(helvetica);

  // const tf2 = form.getTextField(
  //   'form1[0].Page1[0].BeforeYouBegin[0].BusinessInfo[0].AccountNumber[0].BusinessNumber_RT[0]',
  // );
  // tf2.updateAppearances(helvetica);

  // const tf3 = form.getTextField(
  //   'form1[0].Page1[0].BeforeYouBegin[0].BusinessInfo[0].AccountNumber[0].BusinessNumber_RT2[0]',
  // );
  // tf3.setText('foo');
  // tf3.updateAppearances(helvetica);
