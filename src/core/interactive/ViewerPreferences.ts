...
type NonFullScreenPageModeValue =
  | 'UseNone'
  | 'UseOutlines'
  | 'UseThumbs'
  | 'UseOC';
...
class ViewerPreferences {
  ...
  /*
   * Gets the value of the flag specifying whether to hide the conforming reader’s tool bars when the document is active.
  ...
  /*
   * Gets the value of the flag specifying whether to hide the conforming reader’s menu bar when the document is active.
   * Default value if not specified: false.
   */
  ...
  /*
   * Gets the value of the flag specifying whether to hide user interface elements in the document’s window (such as scroll bars and navigation controls), leaving only the document’s contents displayed.
   * Default value if not specified: false.
   */
  ...
  /*
   * Gets the value of the flag specifying whether to resize the document’s window to fit the size of the first displayed page.
   * Default value if not specified: false
   */
  ...
  /*
   * Gets the value of the flag specifying whether to position the document’s window in the center of the screen.
   * Default value if not specified: false.
   */
  ...
  /*
   * Gets the value of the flag specifying whether the window’s title bar should display the document title taken from the Title entry of the document information dictionary.
  ...
  getNonFullScreenPageMode(): NonFullScreenPageModeValue {
    return (
      (this.FindNameVal(
        'NonFullScreenPageMode',
      )?.decodeText() as NonFullScreenPageModeValue) ?? 'UseNone'
    );
  }
  ...
  getDirection(): DirectionValue {
    return (
      (this.FindNameVal('Direction')?.decodeText() as DirectionValue) ?? 'L2R'
    );
  }
   ...
   * Default value if not specified: AppDefault.
  ...
  getPrintScaling(): PrintScalingValue {
    return (
      (this.FindNameVal('PrintScaling')?.decodeText() as PrintScalingValue) ??
      'AppDefault'
    );
  }
  ...
  /*
   * Gets the value of the flag specifying whether the PDF page size shall be used to select the input paper tray.
   ...
   *
   * Default value if not specified: as defined by the conforming reader
   */
   ...
   *
   * Default value if not specified: a empty array (PDF spec defines default as defined by the conforming reader)
   */
  getPrintPageRange(): number[] {
    return (
      this.FindArray('PrintPageRange')
        ?.asArray()
        ?.map((o) => (o as PDFNumber).asNumber()) ?? []
    );
  }
  ...
  /*
   * Sets a flag specifying whether to hide the conforming reader’s tool bars when the document is active.
   * Default value if not specified: false.
   */
  ...
  /*
   * Sets a flag specifying whether to hide the conforming reader’s menu bar when the document is active.
   * Default value if not specified: false.
   */
  ...
  /*
   * Sets a flag specifying whether to hide user interface elements in the document’s window (such as scroll bars and navigation controls), leaving only the document’s contents displayed.
   * Default value if not specified: false.
   */
  ...
  /*
   * Sets a flag specifying whether to resize the document’s window to fit the size of the first displayed page.
   * Default value if not specified: false
   */
  ...
  /*
   * Sets a flag specifying whether to position the document’s window in the center of the screen.
   * Default value if not specified: false.
   */
  ...
  /*
   * Sets a flag specifying whether the window’s title bar should display the document title taken from the Title entry of the document information dictionary.
   * If false, the title bar should instead display the name of the PDF file containing the document.
   * Default value if not specified: false.
   */
  ...
  setNonFullScreenPageMode(nonFullScreenPageMode: NonFullScreenPageModeValue) {
    assertIsOneOf(nonFullScreenPageMode, 'nonFullScreenPageMode', [
      'UseNone',
      'UseOutlines',
      'UseThumbs',
      'UseOC',
    ] as NonFullScreenPageModeValue[]);
  ...
  setPrintScaling(printScaling: PrintScalingValue) {
    assertIsOneOf(printScaling, 'printScaling', [
      'None',
      'AppDefault',
    ] as PrintScalingValue[]);
   ...
   * This setting has no effect onoperating systems that do not provide the ability to pick the input tray by size.
   *
   * Default value if not specified: defined by the conforming reader
   */
  ...
  setPrintPageRange(printPageRange: number[]) {
    ...
    if (printPageRange.length % 2 !== 0) {
      throw new Error(
        'printPageRange must be in pairs - therefore array length must be even',
      );
    }
    const PrintPageRange = this.dict.context.obj(
      printPageRange.map((pr) => this.dict.context.obj(pr)),
    );
   ...
   * Values outside this range shall be ignored.
   *
   * Default value if not specified: defined by the conforming reader, but typically 1
   */
